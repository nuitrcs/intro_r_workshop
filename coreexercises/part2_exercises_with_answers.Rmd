...
rmarkdown::render('part2_exercises_with_answers.Rmd',
                  output_file = 'part2_exercises_with_answers.html',
                  params = list(answers=TRUE))
rmarkdown::render('part2_exercises_with_answers.Rmd',
                  output_file = 'part2_exercises.html',
...
```{r, echo=answers, eval=answers}
mysubsets<-list(shortpetals=iris[iris$Petal.Length < 3,], shortsepals=iris[iris$Sepal.Length < 5,])
mysubsets
