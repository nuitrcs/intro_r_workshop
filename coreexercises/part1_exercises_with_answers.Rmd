...
Print the vector out with the elements in reverse order.  Hint: you don't need a function to do this; you can do it based on how you specify the indices to select from the vector.
...
```{asis, echo=answers, eval=answers}
Or, using the lubridate package, although it doesn't have an easy way to get name of the day of the week
```
...
wday(ymd("1980-01-01"))
weekdays(ymd("1980-01-01")) ## weekdays isn't in lubridate
```
