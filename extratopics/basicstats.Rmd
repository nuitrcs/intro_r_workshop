...
We added cylinders as a numeric variable above, but maybe it should be categorical?  Also, a different way to specify the horsepower terms

```{r}
r3 <- lm(mpg ~ poly(hp, 2) + am + I(factor(cyl)), data=mtcars)
summary(r3)
```
